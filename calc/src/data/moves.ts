...
const DPP_old: {[name: string]: MoveData} = extend(true, {}, ADV, DPP_PATCH);

const DPP_VGC_PATCH: {[name: string]: DeepPartial<MoveData>} = {
    "Pound": {
        "bp": 40,
        "type": "Normal",
        "category": "Physical",
...
const DPP: {[name: string]: MoveData} = extend(true, {}, DPP_old, DPP_VGC_PATCH);
...
const BW_old: {[name: string]: MoveData} = extend(true, {}, DPP_old, BW_PATCH);

const BLACK_DAIZO_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  'Absorb': {bp: 30},
...
const BW: {[name: string]: MoveData} = extend(true, {}, BW_old, BLACK_DAIZO_PATCH);
...
const XY: {[name: string]: MoveData} = extend(true, {}, BW_old, XY_PATCH);
...
const SS_old: {[name: string]: MoveData} = extend(true, {}, SM, SS_PATCH);

const GG_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  "Pound": {
    "bp": 40,
    "type": "Normal",
    "category": "Physical",
...
const SS: {[name: string]: MoveData} = extend(true, {}, SS_old, GG_PATCH);
...
const SV_old: {[name: string]: MoveData} = extend(true, {}, SS_old, SV_PATCH);
