...
const SS_old: {[name: string]: SpeciesData} = extend(true, {}, SM, SS_PATCH);

delete SS_old['Pikachu-Starter'];
delete SS_old['Eevee-Starter'];

const GG_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
    "Bulbasaur": {
        "types": [
            "Grass",
            "Poison"
...
const SS: {[name: string]: SpeciesData} = extend(true, {}, SS_old, GG_PATCH);
const SS3 = SS_old;
